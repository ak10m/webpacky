...
if defined?(Rails)
  ...
  class Webpacky::Rails::HelpersTest < ActionView::TestCase
    setup do
    ...
    test "javascript_bundle_tag" do
      Webpack::Manifest.stub :entries, @script_manifest do
    ...
    test "stylesheet_bundle_tag" do
      Webpack::Manifest.stub :entries, @style_manifest do
        Webpack::DevServer.stub :config, Webpack::DevServer::Configuration.new do
          Webpack::DevServer.configure do |c|
            c.proxy_path = "/web/pack/"
          end
    ...
    test "image_bundle_tag" do
      Webpack::Manifest.stub :entries, @image_manifest do
        Webpack::DevServer.stub :config, Webpack::DevServer::Configuration.new do
          Webpack::DevServer.configure do |c|
            c.proxy_path = "/web/pack/"
          end
